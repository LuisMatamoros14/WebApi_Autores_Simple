...
namespace WebApi_Autores.Filtros
{
    public class HATEOASAutorFilterAttribute : HATEOASFiltroAttribute
    {
        ...
        public override async Task OnResultExecutionAsync(ResultExecutingContext context, ResultExecutionDelegate next)
        {
            ...
            if(autorDTO == null)
            {
                var autoresDTO = resultado.Value as List<AutorDTO> ?? throw new ArgumentNullException("Se esperaba una instancia de AutorDTO o List<AutorDTO>");
