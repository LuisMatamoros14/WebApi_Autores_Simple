...
namespace WebApi_Autores.Servicios
{
    public class HashService
    {
        ...
        {
            var llaveDerivada = KeyDerivation.Pbkdf2(password: textoPlano,salt:sal, KeyDerivationPrf.HMACSHA1,iterationCount: 10000,numBytesRequested: 32);
